...
class ScraperLogger:
    ...
    def success(self, title: str, details: str = "") -> None:
        ...
        self.log_callback(message)
        self.py_logger.info(f"SUCCESS: {title}: {details}" if details else f"SUCCESS: {title}")
    ...
    def custom(self, emoji_key: str, title: str, details: str = "") -> None:
        ...
        self.log_callback(message)
        self.py_logger.info(f"CUSTOM: {title}: {details}" if details else f"CUSTOM: {title}")
...
def create_logger(module_name: str, log_callback: Optional[Callable[[str], None]] = None) -> ScraperLogger:
    """Create a standardized logger instance"""
    return ScraperLogger(module_name, log_callback)


def migrate_log_callback(log_callback: Callable[[str], None], module_name: str) -> ScraperLogger:
    """
